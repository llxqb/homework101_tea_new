 ...
 * 我的学生adapter
 */
public class TodayFeedBackAdapter extends BaseQuickAdapter<TodayFeedBackResponse, BaseViewHolder> {

    public TodayFeedBackAdapter(@Nullable List<TodayFeedBackResponse> data) {
