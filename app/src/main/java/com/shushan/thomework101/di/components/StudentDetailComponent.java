 ...
 */
@PerActivity
@Component(dependencies = AppComponent.class, modules = {StudentDetailModule.class, ActivityModule.class})
public interface StudentDetailComponent extends ActivityComponent {
    void inject(StudentDetailActivity activity);
