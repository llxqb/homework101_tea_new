 ...
 */
@PerActivity
@Component(dependencies = AppComponent.class, modules = {StudentReplaceDetailModule.class, ActivityModule.class})
public interface StudentReplaceDetailComponent extends ActivityComponent {
    void inject(StudentReplacementDetailActivity activity);
